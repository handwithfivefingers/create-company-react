...
const File1A = React.forwardRef((props, ref) => {
	return (
		<div ref={ref} className="container">
			...
			<Row>
				<Col span={24} align='left'>
					...
					<Typography.Paragraph>
						Ông/Bà <i>(ghi rõ họ và tên) :</i> .....<br />
						Sinh ngày: …/…/…<br />
						Loại giấy tờ pháp lý:……… <br />
						Số giấy tờ pháp lý: … 		Ngày cấp: ……	Nơi cấp: ……<br />
						Là Chủ sở hữu của Công ty TNHH ….. đồng ý ký tên và chấp thuận thành lập Công ty TNHH ...với Điều lệ được thông qua theo quy định của Luật Doanh nghiệp số 59/2020/QH14  được Quốc Hội nước Cộng hòa Xã hội Chủ nghĩa Việt Nam thông qua ngày 17/6/2020, gồm các điều, khoản của Điều lệ này như sau:<br />
					</Typography.Paragraph>
				</Col>
			</Row>
			<Row>
			...
			<Row>
				<Col span={24} align='left'>
					<Typography.Text strong>Điều 1. Tư cách pháp nhân, phạm vi trách nhiệm, thời hạn hoạt động</Typography.Text><br />
				</Col>
			</Row>
			<Row>
				<Col span={24} align='left'>
			...
			<Row>
				<Col span={24} align='left'>
					...
					<Typography.Paragraph>
						Tên công ty viết bằng tiếng Việt <i>(ghi bằng chữ in hoa)</i>: ...... ...<br /> {/**GHI BẰNG CHỮ IN HOA */}
						Tên công ty viết bằng tiếng nước ngoài <i>(nếu có)</i>: ... .. ...<br />
						Tên công ty viết tắt <i>(nếu có)</i>: .. ... ...<br />
					</Typography.Paragraph>
				</Col>
			</Row>
			<Row>
				<Col span={24} align='left'>
					...
					<Typography.Paragraph>
						...
						Địa chỉ chi nhánh <i>(nếu có)</i>: ... .. ...<br />
						Địa chỉ văn phòng đại diện <i>(nếu có)</i>: ...  ...<br />
					</Typography.Paragraph>
				</Col>
			</Row>
			<Row>
				<Col span={24} align='left'>
					...
					<Table size='small' dataSource={Nganhnghekinhdoanh} pagination={false} className="CC_table">
			...
			<Row>
				<Col span={24} align='left' style={{ lineHeight: '23px' }}>
					<Typography.Text strong>
					...
					<Typography>1. Vốn điều lệ của công ty trách nhiệm hữu hạn một thành viên khi đăng ký thành lập doanh nghiệp là tổng giá trị tài sản do chủ sở hữu công ty cam kết góp và ghi trong Điều lệ công ty.<br />
					...
					<Typography>
						...
						2. Quyết định tăng vốn điều lệ của công ty; chuyển nhượng một phần hoặc toàn bộ vốn điều lệ của công ty cho tổ chức, cá nhân khác; quyết định phát hành trái phiếu;<br />
						3. Quyết định thành lập công ty con, góp vốn vào công ty khác;<br />
						4. Quyết định việc sử dụng lợi nhuận sau khi đã hoàn thành nghĩa vụ thuế và các nghĩa vụ tài chính khác của công ty;<br />
						5. Quyết định tổ chức lại, giải thể và yêu cầu phá sản công ty;<br /><br /><br />
						6. Thu hồi toàn bộ giá trị tài sản của công ty sau khi công ty hoàn thành giải thể hoặc phá sản;<br />
						7. Quyền khác theo quy định của Luật Doanh nghiệp và Điều lệ công ty <Typography.Text italic>(nếu có)</Typography.Text>.<br />
					</Typography>
					<Typography.Text strong>
			...
			<Row>
				<Col span={24} align='left'>
					...
					<Typography.Paragraph>
						1. Công ty có Chủ tịch công ty, Giám đốc (hoặc Tổng giám đốc).<br />
						2. Chủ sở hữu công ty là Chủ tịch công ty và có thể kiêm hoặc thuê người khác làm Giám đốc (hoặc Tổng giám đốc).<br />
						3. Quyền, nghĩa vụ của Giám đốc (hoặc Tổng giám đốc) được quy định tại Điều lệ công ty và hợp đồng lao động.<br />
					</Typography.Paragraph>
					<br />
					<Typography.Text strong>
					...
					<Row>
						...
						<Col span={12} align="center">
							<Typography.Text>
								...
								<Typography.Text>Họ, tên, chữ ký của Chủ sở hữu công ty</Typography.Text>
