      ...
      <div className={clsx([styles.container, 'fluid-container'])}>
        <Row gutter={[16, 12]} style={{ padding: 40 }}>
          ...
          <Col lg={12} md={12} sm={24} xs={24} className={styles.actionsBtn} align="center">
            ...
            <CCButton outline style={{ fontSize: 18, padding: '10px', color: '#fff' }}>
              Email
            </CCButton>
          </Col>
        </Row>

        <Row gutter={[16, 12]} style={{ background: '#333', padding: 12 }}>
          <Col span={24} align="center" style={{ background: '#333', padding: 12 }}>
