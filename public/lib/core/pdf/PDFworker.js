...
*****************************************************************************/
  ...
  $jscomp.polyfill(
    ...
    function (e) {
      ...
      m.prototype.resolveToNonPromiseObj_ = function (c) {
        ...
        "function" == typeof a
          ? this.settleSameAsThenable_(a, c)
          : this.fulfill_(c);
      };
      ...
      m.race = function (c) {
        return new m(function (a, b) {
          for (
            var h = $jscomp.makeIterator(c), v = h.next();
            !v.done;
            v = h.next()
          )
        ...
        return b.done
          ...
          : new m(function (h, c) {
              ...
              do
                p.push(void 0),
                  d++,
                  g(b.value).callWhenSettled_(v(p.length - 1), c),
                  (b = a.next());
              while (!b.done);
            });
      };
  ...
  (function (e) {
    ...
    n.t = function (d, m) {
      m & 1 && (d = n(d));
      if (m & 8 || (m & 4 && "object" === typeof d && d && d.__esModule))
        return d;
          ...
          return Object(d.a)(void 0, void 0, Promise, function () {
            ...
            return Object(d.b)(this, function (a) {
              switch (a.label) {
                ...
                case 2:
                  return (
                    (l = self.BrotliDecode(Object(r.b)(k))),
                    [2, f ? l : Object(r.a)(l)]
                  );
              }
            });
      ...
      (function () {
        ...
        k.prototype.End = function () {
          if (this.remainingDataArrays.length) {
            for (var k = this.arrays, f = 0, l = 0; l < k.length; ++l)
              f += k[l].length;
            f = new Uint8Array(f);
            var a = 0;
          ...
          var c = function () {
            ...
            h.length < k.compressedMaximum
              ? ((h = k.decompressFunction(h, k.shouldOutputArray)),
                ...
                b &&
                  Object(m.a)("worker", "Decompressed length is " + h.length))
              : f && (h = Object(r.a)(h));
            b &&
              Object(m.a)(
                "worker",
                k.url + " Decompression took " + (Date.now() - c)
              );
            return h;
          };
          if (k.isAsync)
    ...
    function (e, n, g) {
      ...
      var d = function (c) {
          if ("string" === typeof c) {
            for (
              var d = new Uint8Array(c.length), a = c.length, b = 0;
              b < a;
              b++
            )
              d[b] = c.charCodeAt(b);
    ...
    function (e, n, g) {
      ...
      var r = (function () {
          var a = d.navigator.userAgent.match(
              ...
              function (b, c, d) {
                ...
                c.exports = (function () {
                  function b(b) {
                    ...
                    this.data =
                      (null != (c = this.options.initialValues)
                        ? c.slice(0)
                        : void 0) || [];
    ...
    function (e, n, g) {
      function d(a, b, h) {
        ...
        return d(!!WebAssembly.instantiateStreaming).then(function (a) {
          Object(m.a)(
            "load",
            "WASM compilation took " + (Date.now() - (e || p)) + " ms"
          );
          return a;
        });
      }
        ...
        b = function (b, c, e) {
          if (r() && !e)
            (self.Module.instantiateWasm = function (a, h) {
              return Object(m.a)(b + "Wasm.wasm", a, c["Wasm.wasm"]).then(
                function (a) {
                  h(a.instance);
                }
              );
            ...
            try {
              ...
              switch (a[0]) {
                ...
                default:
                  ...
                  if (3 === a[0] && (!p || (a[1] > p[0] && a[1] < p[3])))
                    h.label = a[1];
                  else if (6 === a[0] && h.label < p[1])
                    (h.label = p[1]), (p = a);
    ...
    function (e, n) {
      ...
      function m(a) {
        ...
        if ((v === g || !v) && setTimeout)
          return (v = setTimeout), setTimeout(a, 0);
        try {
          return v(a, 0);
        } catch (A) {
          try {
      ...
      function c(a) {
        ...
        if ((y === d || !y) && clearTimeout)
          return (y = clearTimeout), clearTimeout(a);
        try {
          return y(a);
        } catch (A) {
          try {
      ...
      function r() {
        u &&
          z &&
          ((u = !1), z.length ? (p = z.concat(p)) : (t = -1), p.length && a());
      }
      function a() {
        if (!u) {
          var a = m(r);
      ...
      e.nextTick = function (c) {
        ...
        if (1 < arguments.length)
          for (var d = 1; d < arguments.length; d++) h[d - 1] = arguments[d];
        p.push(new b(c, h));
        1 !== p.length || u || m(a);
      };
    ...
    function (e, n, g) {
      ...
      e = (function () {
        ...
        e.prototype.on = function (c, e, a) {
          ...
          b[c] &&
            Object(d.c)('There is already an actionName called "' + c + '"');
          b[c] = [e, a];
        };
        ...
        e.prototype.sendError = function (c, d) {
          if (c.message || c.errorData) {
            ...
            var a = c.errorData;
            c = {
              type: c.type ? c.type : "JavascriptError",
              message: c.message,
            };
            a &&
        ...
        e.prototype.getPromise = function (c) {
          if (c in this.callbacksCapabilities)
            return this.callbacksCapabilities[c];
        ...
        e.prototype.cancelPromise = function (c) {
          if (c in this.callbacksCapabilities) {
            ...
            this.pdfnetActiveCommands.has(c) &&
              this.pdfnetActiveCommands.delete(c);
            e.reject({
              type: "Cancelled",
        ...
        (function (c, d) {
          ...
          if (!c.setImmediate) {
            ...
            r.setImmediate = function (a) {
              "function" !== typeof a && (a = new Function("" + a));
              for (
                var f = Array(arguments.length - 1), l = 0;
                l < f.length;
                l++
              )
                f[l] = arguments[l + 1];
          ...
          g.Module = {
            ...
            loadDoc: function (a, b) {
              ...
              try {
                ...
                a.customHandlerId &&
                  Module._TRN_PDFNetAddPDFTronCustomHandler(a.customHandlerId);
            ...
            onRuntimeInitialized: function () {
              ...
              (function (a) {
                ...
                a.XFDFMerge = function (a, d, e) {
                  if (d) {
                    ...
                    try {
                      Object(c.b)(
                        "worker",
                        "Merge XFDF of length ".concat(d.length)
                      );
                ...
                a.ReadBufferFile = function (a, c) {
                  ...
                  c &&
                    (Module.docs[a].buffer = new Uint8Array(b.buffer.slice(0)));
                  return b;
                };
                    ...
                    try {
                      ...
                      if (m) {
                        ...
                        try {
                          ...
                          for (v = -1; Module.IteratorHasNext(x); ) {
                            ...
                            try {
                              ...
                              var y = Module.PageGetPageInfo(D),
                                z = Module.ElementBuilderCreateImage(
                                  f,
                                  E,
                                  0,
                                  0,
                          ...
                          console.warn(
                            "Watermarks can not be added due to error: " + I
                          );
                        }
                      }
                      k = 0;
                  ...
                  return new Promise(function (b, h) {
                    ...
                    try {
                      ...
                      if (r) {
                        ...
                        0 !== k &&
                          (REX(
                            Module._TRN_PDFRasterizerSetOCGContext(q.rast, k)
                          ),
                          w.push(function () {
                      ...
                      t.hasOwnProperty("caching") &&
                        REX(
                          Module._TRN_PDFRasterizerSetCaching(q.rast, t.caching)
                        );
                      t.hasOwnProperty("expGamma") &&
                        REX(
                          Module._TRN_PDFRasterizerSetGamma(q.rast, t.expGamma)
                        );
                      ...
                      if (10 === I) {
                        ...
                        b({
                          pageBuf: O,
                          pageWidth: q.out_width,
                          pageHeight: q.out_height,
                        });
                      } else {
                      ...
                      var P = new Date().getTime(),
                        S = e(function Q() {
                          try {
                            for (
                              var a = 0, f = new Date().getTime(), l = !1;
                              200 > a;
                      ...
                      ? (d in downloadDataMap &&
                          REX(
                            Module._TRN_PDFDocDownloaderInitialize(
                              d,
                              downloadDataMap[d].downloader
                            )
                          ),
                        {
                          success: !0,
                          pageDimensions: Module.GetPageDimensions(d),
                        })
                      : { success: !1 };
                  } finally {
                    Module.stackRestore(b);
                ...
                a.InsertPages = function (a, c, d, e, g, m) {
                  return new Promise(function (b, h) {
                    ...
                    try {
                      ...
                      for (
                        var v = d.length, f = Module.PageSetCreate(), l = 0;
                        l < v;
                        ++l
                      )
                ...
                a.MovePages = function (a, c, d) {
                  return new Promise(function (b, e) {
                    ...
                    try {
                      ...
                      for (
                        var m = c.length, n = Module.PageSetCreate(), q = 0;
                        q < m;
                        ++q
                      )
                ...
                a.RotatePages = function (a, c, d) {
                  return new Promise(function (b, e) {
                    ...
                    try {
                      ...
                      for (
                        var v = c[0];
                        Module.IteratorHasNext(q) && n < c[m - 1];
                        ++v
                      ) {
                        if (v === c[n]) {
                ...
                a.CropPages = function (a, c, d, e, g, m) {
                  return new Promise(function (b, h) {
                    ...
                    try {
                      ...
                      for (
                        var f = [], l = c[0];
                        Module.IteratorHasNext(r) && u < c[t - 1];
                        ++l
                      ) {
                        if (l === c[u]) {
      ...
      (function (d) {
        ...
        (function (a) {
          ...
          z.prototype = {
            read: function (a, l, k) {
              k =
                this.filePosition + k <= this.fileLength
                  ? k
                  : this.fileLength - this.filePosition;
              a = a.subarray(l, l + k);
              l = k;
              for (
                var f = this.filePosition % this.chunkSize,
                  b = this.filePosition - f,
                  c = 0;
                0 < k;
                ...
                if (this.chunkCache.has(b)) var d = this.chunkCache.get(b);
                  ...
                  (d = new Int8Array(
                    this.reader.readAsArrayBuffer(
                      this.file.slice(b, b + this.chunkSize)
                    )
                  )),
          ...
          w.prototype = {
            ...
            keepVisibleChunks: function (a, l) {
              for (
                var f = l.length, b = Module.chunkMax / 2, c = 0, d = 0;
                d < f;
                ++d
              ) {
          ...
          var J = function (f) {
            return "Exception: \n\t Message: "
              .concat(
                a.GetJSStringFromCString(Module._TRN_GetMessage(f)),
                "\n\t Filename: "
              )
              .concat(
                a.GetJSStringFromCString(Module._TRN_GetFileName(f)),
                "\n\t Function: "
              )
              .concat(
                a.GetJSStringFromCString(Module._TRN_GetFunction(f)),
                "\n\t Linenumber: "
              )
          ...
          a.DownloaderHint = function (a, b) {
            ...
            if (b.visiblePages) {
              ...
              Object.keys(c.requirePageCallbacks).forEach(function (a) {
                c.requirePageCallbacks.hasOwnProperty(a) &&
                  l.push(parseInt(a, 10));
              });
              (b = Module.docs[a].chunkStorage) &&
                b.keepVisibleChunks(c.downloader, l);
              a = l.length;
                ...
                notifyUpdatePage: Module.addFunction(
                  b(function (a, b, c, f) {
                    ...
                    if (b in k.requirePageCallbacks)
                      for (
                        c = k.requirePageCallbacks[b], f = 0;
                        f < c.length;
                        ++f
                      )
                        c[f]();
          ...
          a.CreateDocDownloaderBackend = function (a, b, c) {
            ...
            var e = a.downloadData
              ? new F(a.downloadData, f, c, l, d)
              : new F(a.size, f, c, l, d);
              ...
              if (f)
                if ("ptr" === g) Module.docs[l] = { ptr: f };
                  ...
                  if (m) a.CreateDocDownloaderBackend(f, h, l);
                    ...
                    if (
                      n &&
                      ((f = new Uint8Array(f)), 10485760 > f.length + b && !g)
                    ) {
                      b += f.length;
                      var q = f.length,
                    ...
                    Module.docs[l] = n;
                    if (g) {
                      if (c.pageSizes && c.pageSizes.length)
                        var r = c.pageSizes[0];
          ...
          a.ChangeDocBackend = function (a, l) {
            ...
            f
              ? (f.bufPtr &&
                  f.ownership &&
                  (Module._free(f.bufPtr), (b -= f.bufPtrSize)),
          ...
          a.PDFRasterizerRasterizeSeparations = function (a, b, c, d, e, g, h) {
            ...
            c = Array(b);
            for (d = 0; d < b; ++d)
              (e = Module.VectorGetAt(a, d)),
                (c[d] = Module.ExtractSeparationData(e));
          ...
          a.ElementBuilderCreateImage = function (a, b, c, d, e, g) {
            var k = Module.allocate(4, "i8", Module.ALLOC_STACK);
            REX(
              Module._TRN_ElementBuilderCreateImageScaled(a, b, c, d, e, g, k)
            );
        ...
        e.SetupPDFNetFunctions = function (c) {
              ...
              n = function (c, d) {
                return new Promise(function (e, h) {
                  ...
                  (p = Module.EMSCallSharedFunction(b, d, p))
                    ? h({
                        type: "InvalidPDF",
                        message: Module.GetErrToString(p),
                      })
          ...
          if (Module._TRN_EMSCreatePDFNetWorkerInstance) {
            ...
            for (
              ...
              if (((h = Module.GetJSStringFromCString(h)), !p[h]))
                c.onAsync(h, n);
            Module._TRN_EMSFunctionIteratorDestroy(m);
          }
        };
          ...
          setup: function (c) {
            function g(c) {
              var d = c.data,
                k = c.action;
              var f =
                "GetCanvas" === k || "GetCanvasPartial" === k
                  ? r.shouldRunRender(d)
                  : !0;
              if (f) {
                e = c;
